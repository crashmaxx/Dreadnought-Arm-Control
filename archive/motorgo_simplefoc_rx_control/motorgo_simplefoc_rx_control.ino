...
#include "commander_i2c/I2CCommanderMaster.h"
#include "commander_i2c/SimpleFOCRegisters.h"

#define I2C_SPEED 400E3
#define I2C_SDA 47
#define I2C_SCL 38
#define SENSE_ADDR 0x36
#define TARGET_I2C_ADDRESS 0x60

// global instance of commander - controller device version
commander_i2c::I2CCommanderMaster command_i2c;
...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  ...
  //command_i2c.writeRegister(0, REG_TARGET, &ch0_angle, 4);
...
void setup() {
    ...
    Wire.begin(I2C_SDA, I2C_SCL);                   // initialize i2c in controller mode
    command_i2c.addI2CMotors(TARGET_I2C_ADDRESS, 1);            // add target device, it has 1 motor
    command_i2c.init();               // init commander

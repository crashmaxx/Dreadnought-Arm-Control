...
namespace commander_i2c {
    ...
    I2CCommanderMaster motors_i2c;



    I2CCommanderMaster::I2CCommanderMaster(int maxMotors)  : CommanderMaster(), maxMotors(maxMotors), motors(new I2CRemoteMotor[maxMotors]) {    
    };
